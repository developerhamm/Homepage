...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <jsp:useBean id="studentDAO" class="kr.or.kh.haksa.StudentDAO" scope="page"></jsp:useBean>
    <jsp:useBean id="studentDTO" class="kr.or.kh.haksa.StudentDTO" scope="page"></jsp:useBean>
...
<table  border="1" cellspacing="0" cellpadding="0">
    ...
    <a href = "student_searchForm.jsp">학생검색</a>&nbsp;
    <a href = "student_deleteForm.jsp">학생삭제</a>&nbsp;
    <a href = "student_updateForm.jsp">학생수정</a>&nbsp;
