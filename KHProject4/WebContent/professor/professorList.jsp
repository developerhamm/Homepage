...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <jsp:useBean id="professorDAO" class="kr.or.kh.haksa.ProfessorDAO" scope="page"></jsp:useBean>
    <jsp:useBean id="professorDTO" class="kr.or.kh.haksa.ProfessorDTO" scope="page"></jsp:useBean>
...
<table  border="1" cellspacing="0" cellpadding="0">
    ...
    <a href = "professor_searchForm.jsp">교수검색</a>&nbsp;
    <a href = "professor_deleteForm.jsp">교수삭제</a>&nbsp;
    <a href = "professor_updateForm.jsp">교수수정</a>&nbsp;
