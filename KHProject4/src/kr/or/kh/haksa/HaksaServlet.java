...
public class HaksaServlet extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      out.print("</style>");
      out.print("번호:"+studentDTO.getNo()+"나이:"+studentDTO.getAge()+"이름:"+studentDTO.getIrum()+"학번:"+studentDTO.getHakbun()+"<BR>");
      ...
      out.print("ul{list-style-type:none;}");
      out.print("</style>");
      out.print("번호:"+professorDTO.getNo()+"나이:"+professorDTO.getAge()+"이름:"+professorDTO.getIrum()+"과목:"+professorDTO.getSubject()+"<BR>");
      out.print("정말로 수정하시겠습니까?");
        out.print("<h1>최종수정 하기전 내용입니다.</h1>");
      ...
      out.print("ul{list-style-type:none;}");
      out.print("</style>");
      out.print("번호:"+managerDTO.getNo()+"나이:"+managerDTO.getAge()+"이름:"+managerDTO.getIrum()+"부서:"+managerDTO.getPart()+"<BR>");
      out.print("정말로 수정하시겠습니까?");
        out.print("<h1>최종수정 하기전 내용입니다.</h1>");
